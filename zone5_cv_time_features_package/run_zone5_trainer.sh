...
SOURCE_PARQUET="${SOURCE_PARQUET:-data/zone5_training_cv.parquet}"
SOURCE_CSV="${SOURCE_CSV:-data/zone5_training_cv.csv}"
SNAPSHOT_SOURCE="${SNAPSHOT_SOURCE:-csv}"
SOURCE_METADATA="${SOURCE_METADATA:-data/zone5_training_cv.metadata.json}"
...
exec "$PYTHON_BIN" -m zone5.retrain_once "${TRAINER_ARGS[@]}"
