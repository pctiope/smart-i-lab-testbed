...
| `test_live.py` | Live connectivity and ingestion monitor |
...
```cmd
python.exe test_live.py --all --check-only
python.exe test_live.py --device-type air-1 --check-only
python.exe test_live.py --all
python.exe test_live.py --all --poll 120
```

### Linux

```bash
python3 test_live.py --all --check-only
python3 test_live.py --device-type air-1 --check-only
python3 test_live.py --all
python3 test_live.py --all --poll 120
```
